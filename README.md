...
```bash
npm install firestore-edge
```

```bash
pnpm add firestore-edge
```

```bash
yarn add firestore-edge
```
...
```typescript
import { db, FieldValue } from "firestore-edge";
...
```typescript
import { db, Timestamp } from "firestore-edge";
...
```typescript
import { db, GeoPoint } from "firestore-edge";
...
```typescript
import { db, FieldPath } from "firestore-edge";
